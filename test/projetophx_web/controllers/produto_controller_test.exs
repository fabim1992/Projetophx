defmodule ProjetophxWeb.ProdutoControllerTest do
  use ProjetophxWeb.ConnCase

  import Projetophx.MercadoFixtures

  @create_attrs %{categoria: "some categoria", nome: "some nome", preco: 120.5}
  ...
  describe "index" do
    test "lists all produto", %{conn: conn} do
      ...
      assert html_response(conn, 200) =~ "Listing Produto"
    end
  end
